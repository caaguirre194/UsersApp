...
export class SigninPage implements OnInit {
  ...
  validatePassword(pass: string, passs2: string) {
    if (
      (<HTMLInputElement>document.getElementById("password2")).value == pass &&
      (<HTMLInputElement>document.getElementById("password2")).value.length > 5
    ) {
      console.log(
        (<HTMLInputElement>document.getElementById("password2")).value.length
      );
