...
export class SigninPage implements OnInit {
  ...
  @ViewChild("messageInputEmail") public messageInputname;

  @ViewChild("messageInputEmail") public messageInputPassword;
  @ViewChild("messageInputEmail") public messageInputPassword2;
